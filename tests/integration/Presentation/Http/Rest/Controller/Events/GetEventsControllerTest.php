...
namespace Micro\User\Tests\Integration\Presentation\Http\Rest\Controller\Events;
...
use Micro\User\Tests\Unit\Infrastructure\Share\Event\Publisher\InMemoryProducer;
...
class GetEventsControllerTest extends JsonApiTestCase
{
    ...
    public function eventsShouldBePresentInElasticSearchTest(): void
    {
        ...
        self::assertSame('Micro.User.Domain.Event.UserWasCreated', $responseDecoded['data'][0]['type']);
    ...
    protected function setUp()
    {
        ...
        $consumersRegistry->addConsumer('Micro.User.Domain.Event.UserWasCreated', $consumer);
