...
namespace Micro\User\UI\Http\Rest\Controller\User;

use Assert\Assertion;
use League\Tactician\CommandBus;
use Micro\User\Application\Command\User\ChangeEmail\ChangeEmailCommand;
use Micro\User\Domain\User\Auth\SessionInterface;
use Micro\User\Domain\User\Exception\ForbiddenException;
use Micro\User\UI\Http\Rest\Controller\CommandController;
